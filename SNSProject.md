...
1. Configure the aws cli and run the below shell script
...
2. After running you will get a new mail to your mail id to accept the subscription froma aws
